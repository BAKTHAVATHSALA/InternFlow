...
const getDisplayStage = (status) => {
  const map = { applied: 'Applied', screened: 'Screened', offer_pending: 'Offer', onboarded: 'Onboarded', rejected: 'Rejected' };
...
const Pipeline = () => {
  ...
  const KanbanColumn = ({ stageValue, stageDisplay }) => {
    ...
    return (
      <div className="flex flex-col gap-3 min-w-[260px] bg-slate-50 p-4 rounded-2xl border border-slate-100">
